...
|---|---|---|
| [html5-qrcode](https://github.com/mebjas/html5-qrcode) | Leitura de QR pela câmera e por imagem | Baixe `html5-qrcode.min.js` e coloque em `/libs` |
| [Chart.js](https://www.chartjs.org/) | Gráfico de consultas por dia | Baixe `chart.js` (versão UMD) e coloque em `/libs/chart.min.js` |

Sem esses dois arquivos em `/libs`, o app abre e funciona normalmente (navegação, consulta manual, histórico, favoritos, tema), exceto: leitura de QR (câmera/imagem) e o gráfico de estatísticas.
